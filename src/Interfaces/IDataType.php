...
interface IDataType {
    ...
    const DATA_TEPE_CLASS_ARRAY = "array";
    const DATA_TEPE_CLASS_BOOLEAN = "boolean";
    const DATA_TEPE_CLASS_DATE_TIME = "dateTime";
    const DATA_TEPE_CLASS_ENTITY = "entity";
    const DATA_TEPE_CLASS_FLOAT = "float";
    const DATA_TEPE_CLASS_INTEGER = "integer";
    const DATA_TEPE_CLASS_MIXED = "mixed";
    const DATA_TEPE_CLASS_OBJECT = "object";
    const DATA_TEPE_CLASS_STRING = "string";
    ...
    /**
     * @return array Parameter names e.g. ["lenght", "unsigned"].
     */
